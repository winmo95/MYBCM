...
public class Bluetooth extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        test = getname.getStringExtra("NAME") +"?" +getname.getStringExtra("COMPANY") + "?" +getname.getStringExtra("RANK") + "?" +getname.getStringExtra("ADDRESS")+"?"
                + getname.getStringExtra("TEL") +"?" + getname.getStringExtra("PHONE") + "?" +getname.getStringExtra("FAX") + "?" +getname.getStringExtra("EMAIL");

        save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gohome = new Intent(getBaseContext(), EditorActivity.class);

                StringTokenizer tokens = new StringTokenizer(messages.toString());
                ...
                gohome.putExtra("NAME", sName);
                gohome.putExtra("COMPANY", sCompany);
                gohome.putExtra("RANK",srank);
                gohome.putExtra("ADDRESS",saddress);
                gohome.putExtra("TEL", stel);
                gohome.putExtra("PHONE",sphone);
                gohome.putExtra("FAX",sfax);
                gohome.putExtra("EMAIL", semail);
